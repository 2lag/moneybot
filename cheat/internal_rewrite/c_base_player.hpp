...
public:
    ...
    __forceinline const char* get_str( std::ptrdiff_t offset ) {
	    return reinterpret_cast< const char* >( uintptr_t( this ) + offset );
	}
	...
	__forceinline CCSGOPlayerAnimState* get_animstate( ) {
		...
		return *reinterpret_cast< CCSGOPlayerAnimState** >( uintptr_t( this ) + offset - 0x14  );
	}
