...
namespace ui
{
    ...
    static std::vector< dropdown_item_t< > > jump_bug_types = {
      ...
      { xors( "hold" ), 1 }
		...
		static std::vector< dropdown_item_t<> > menu_themes = {
			{ xors( "dark" ), 0 },
			{ xors( "light" ), 1 }
		};
		...
		{ xors( "orbit mk01" ), 656 },
		{ xors( "blueprint" ), 657 },
		{ xors( "cobra strike" ), 658 },
		{ xors( "macabre" ), 659 },
		{ xors( "hyper beast" ), 660 },
		{ xors( "sugar rush" ), 661 },
		{ xors( "oni taiji" ), 662 },
		{ xors( "briefing" ), 663 },
		{ xors( "hellfire" ), 664 },
		...
		{ xors( "red rock" ), 668 },
		{ xors( "death grip" ), 669 },
		{ xors( "death's head" ), 670 },
		{ xors( "cut out" ), 671 },
		{ xors( "metal flowers" ), 672 },
		{ xors( "morris" ), 673 },
		{ xors( "triqua" ), 674 },
		{ xors( "the empress" ), 675 },
		{ xors( "high roller" ), 676 },
		{ xors( "hunter" ), 677 },
		{ xors( "see ya later" ), 678 },
		{ xors( "goo" ), 679 },
		{ xors( "off world" ), 680 },
		{ xors( "leaded glass" ), 681 },
		{ xors( "oceanic" ), 682 },
		{ xors( "llama cannon" ), 683 },
		{ xors( "cracked opal" ), 684 },
		{ xors( "jungle slipstream" ), 685 },
		{ xors( "phantom" ), 686 },
		{ xors( "tacticat" ), 687 },
		{ xors( "exposure" ), 688 },
		{ xors( "ziggy" ), 689 },
		{ xors( "stymphalian" ), 690 },
		{ xors( "mortis" ), 691 },
		{ xors( "night riot" ), 692 },
		{ xors( "flame test" ), 693 },
		{ xors( "moonrise" ), 694 },
		...
		{ xors( "lionfish" ), 698 },
		{ xors( "wild six" ), 699 },
		{ xors( "urban hazard" ), 700 },
		{ xors( "grip" ), 701 },
		{ xors( "aloha" ), 702 },
		{ xors( "swag-7" ), 703 },
		{ xors( "arctic wolf" ), 704 },
		{ xors( "cortex" ), 705 },
		{ xors( "oxide blaze" ), 706 },
		{ xors( "neon rider" ), 707 },
		{ xors( "amber slipstream" ), 708 },
		{ xors( "ecoshred" ), 710 },
		{ xors( "code red" ), 711 },
		{ xors( "high seas" ), 712 },
		{ xors( "warhawk" ), 713 },
		{ xors( "nightmare" ), 714 },
		{ xors( "capillary" ), 715 },
		{ xors( "toy soldier" ), 716 },
		{ xors( "traction" ), 717 },
		{ xors( "paw" ), 718 },
		{ xors( "powercore" ), 719 },
		{ xors( "devourer" ), 720 },
		{ xors( "survivalist" ), 721 },
		{ xors( "snek-9" ), 722 },
		{ xors( "eye of athena" ), 723 },
        { xors( "wild lotus" ), 724 },
        { xors( "day lily" ), 725 },
        { xors( "sunset lily" ), 726 },
        { xors( "midnight lily" ), 727 },
        { xors( "teal blossom" ), 728 },
        { xors( "crimson blossom" ), 729 },
        { xors( "dark blossom" ), 730 },
        { xors( "banana leaf" ), 731 },
        { xors( "synth leaf" ), 732 },
        { xors( "rust leaf" ), 733 },
        { xors( "wild lily" ), 734 },
        { xors( "the prince" ), 736 },
        { xors( "cinquedea" ), 737 },
        { xors( "orange murano" ), 738 },
        { xors( "violet murano" ), 739 },
        { xors( "navy murano" ), 740 },
        { xors( "dark filigree" ), 741 },
        { xors( "red filigree" ), 742 },
        { xors( "orange filigree" ), 743 },
        { xors( "baroque red" ), 744 },
        { xors( "baroque purple" ), 745 },
        { xors( "baroque orange" ), 746 },
		{ xors( "night stripe" ), 735 },
		{ xors( "twin turbo" ), 747 },
		{ xors( "calf skin" ), 748 },
		{ xors( "vino primo" ), 749 },
		{ xors( "integrale" ), 750 },
		...
		{ xors( "slide" ), 755 },
        { xors( "gungnir" ), 756 },
        { xors( "emerald jormungandr" ), 757 },
        { xors( "flame jormungandr" ), 758 },
        { xors( "astral jormungandr" ), 759 },
        { xors( "frost borre" ), 760 },
        { xors( "copper borre" ), 761 },
        { xors( "red stone" ), 762 },
        { xors( "mjolnir" ), 763 },
		{ xors( "facility sketch" ), 775 },
		{ xors( "facility negative" ), 776 },
		{ xors( "facility draft" ), 777 },
		{ xors( "facility dark" ), 778 },
		{ xors( "random access" ), 779 },
		{ xors( "mainframe" ), 780 },
		{ xors( "co-processor" ), 781 },
		{ xors( "motherboard" ), 782 },
		{ xors( "bulkhead" ), 783 },
		{ xors( "coolant" ), 784 },
		{ xors( "mandrel" ), 785 },
		{ xors( "exchanger" ), 786 },
		{ xors( "core breach" ), 787 },
		{ xors( "acheron" ), 788 },
		{ xors( "nuclear garden" ), 789 },
		{ xors( "cold fusion" ), 790 },
		{ xors( "remote control" ), 791 },
		{ xors( "control panel" ), 792 },
		{ xors( "converter" ), 793 },
		{ xors( "sweeper" ), 794 },
		{ xors( "safety net" ), 795 },
		{ xors( "check engine" ), 796 },
		{ xors( "brake light" ), 797 },
		{ xors( "nitro" ), 798 },
		{ xors( "high beam" ), 799 },
		{ xors( "lab rats" ), 800 },
		{ xors( "asiimov" ), 801 },
		{ xors( "momentum" ), 802 },
		{ xors( "neo-noir" ), 803 },
		{ xors( "modest threat" ), 804 },
		{ xors( "mecha industries" ), 805 },
		{ xors( "scavenger" ), 806 },
		{ xors( "signal" ), 807 },
		{ xors( "oxide blaze" ), 808 },
		{ xors( "wood fired" ), 809 },
		{ xors( "phosphor" ), 810 },
		{ xors( "magnesium" ), 811 },
		{ xors( "pipe down" ), 812 },
		...
		{ xors( "light rail" ), 841 },
		{ xors( "akoben" ), 842 },
		{ xors( "skull crusher" ), 843 },
		{ xors( "the emperor" ), 844 },
		{ xors( "momentum" ), 845 },
		{ xors( "gauss" ), 846 },
		{ xors( "mischief" ), 847 },
		{ xors( "verdigris" ), 848 },
		{ xors( "off world" ), 849 },
		{ xors( "incinegator" ), 850 },
		{ xors( "moonrise" ), 851 },
		{ xors( "doppler" ), 852 },
		{ xors( "doppler" ), 853 },
		{ xors( "doppler" ), 854 },
		{ xors( "doppler" ), 855 },
		{ xors( "marble fade" ), 856 },
        { xors( "emerald quartz" ), 859 },
        { xors( "pyre" ), 860 },
        { xors( "barricade" ), 861 },
        { xors( "moss quartz" ), 862 },
        { xors( "night borre" ), 863 },
        { xors( "candy apple" ), 864 },
        { xors( "stone mosaico" ), 865 },
        { xors( "canal spray" ), 866 },
        { xors( "stained glass" ), 867 },
        { xors( "sea calico" ), 868 },
        { xors( "sundown" ), 869 },
        { xors( "jungle thicket" ), 870 },
        { xors( "surfwood" ), 871 },
        { xors( "bamboo garden" ), 872 },
        { xors( "seabird" ), 873 },
        { xors( "embargo" ), 884 },
        { xors( "rat rod" ), 885 },
        { xors( "artic wolf" ), 886 },
        { xors( "containment breach" ), 887 },
        { xors( "acid wash" ), 888 },
        { xors( "decimator" ), 889 },
        { xors( "plume" ), 890 },
        { xors( "black sand" ), 891 },
        ...
        { xors( "bloodshot" ), 899 },
        { xors( "warbird" ), 900 },
        { xors( "boroque sand" ), 920 },
		{ xors( "aztec" ), 902 },
        { xors( "elites 1.6" ), 903 },
        { xors( "decommissioned" ), 904 },
        { xors( "flash out" ), 905 },
        { xors( "buddy" ), 906 },
        { xors( "inferno" ), 907 },
        { xors( "classic crate" ), 908 },
        { xors( "popdog" ), 909 },
        { xors( "hydra" ), 910 },
        { xors( "nostalgia" ), 911 },
        { xors( "death by puppy" ), 913 },
        { xors( "assault" ), 914 },
        { xors( "agent" ), 915 },
        { xors( "plastique" ), 916 },
        { xors( "wildfire" ), 917 },
        { xors( "sacrifice" ), 918 },
        { xors( "commemoration" ), 919 },
