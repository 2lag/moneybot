...
void c_movement::pixel_surf( ) {
  if ( !g_settings.misc.pixel_surf )
    return;

  if ( !g_input.is_key_pressed( ( VirtualKeys_t )g_settings.misc.pixel_surf_key( ) ) )
    return;
  ...
  // https://pastebin.com/2FBBgmpH keep reading @ line 54 and taking relevant notes below
  /*
    numbers in () are jump heights - vertical distance decreased after the highest point of your jump

    Standing/Crouching:
    [Wireframe Height] + 64.09 - 57
    [Wireframe Height] + 64.09 - 56.67(57 - 0.33)
    [Wireframe Height] + 64.09 - 56.22(57 - 0.78)
    [Wireframe Height] + 64.09 - 51(57 - 6)
    [Wireframe Height] + 64.09 - 49.37(57 - 7.63)
 
    Crouch Jump:
    [Wireframe Height] + 64.09 - 66
    [Wireframe Height] + 64.09 - 65.67(66 - 0.33)
    [Wireframe Height] + 64.09 - 65.22(66 - 0.78)
    [Wireframe Height] + 64.09 - 60(66 - 6)
    [Wireframe Height] + 64.09 - 58.37(66 - 7.63)
