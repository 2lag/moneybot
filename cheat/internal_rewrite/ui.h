      ...
      date_str = std::string( "day | lifetime" );
			...
			auto tab_legit = std::make_shared< ui::c_tab_sheet >( xors( "legit" ), &icons::sprite_legit ); {
				...
				auto subtab_main = std::make_shared< ui::c_tab_sheet >( xors( "main" ) ); {
					auto left_column = std::make_shared< ui::base_item >( 0, 0, 0, 0, "left column" );
					auto right_column = std::make_shared< ui::base_item >( 220, -5, 0, 0, "right column" );

					auto main_form = std::make_shared< ui::c_form >( 0, 0, 215, 0, xors( "general" ) ); {
						...
						activation_dropdown->add_item( std::make_shared< ui::c_key_picker_small >( 195, 0, &g_settings.legit.key, xors( "legit_key" ) ) )->set_cond( 
            ...
            main_form->add_item( std::make_shared< ui::c_checkbox >( 0, 0, xors( "auto pistol" ), &g_settings.legit.auto_pistol ) );
					...
					auto backtracking_form = std::make_shared< ui::c_form >( 0, 0, 215, 0, xors( "backtracking" ) ); {
						...
						visualize_checkbox->add_item( std::make_shared< ui::c_color_picker >( 175, 2, 16, &g_settings.legit.backtracking_col ) );
						...
						backtracking_form->add_item( std::make_shared< ui::c_slider< float > >( 0, 0, 120, 0.01f, 0.2f, xors( "max time" ), &g_settings.legit.backtracking_time, "s" ) );
					}
					...
					auto triggerbot_form = std::make_shared< ui::c_form >( 0, 0, 215, 0, xors( "triggerbot" ) ); {
						triggerbot_form->add_item( std::make_shared< ui::c_checkbox >( 0, 0, xors( "enabled" ), &g_settings.legit.triggerbot ) )->add_item(
							std::make_shared< ui::c_key_picker_small >( 195, 0, &g_settings.legit.trigger_key, xors( "trigger_key" ) ) );

						triggerbot_form->add_item( std::make_shared< ui::c_checkbox >( 0, 0, xors( "while flashed" ), &g_settings.legit.trigger_while_flashed ) );
						triggerbot_form->add_item( std::make_shared< ui::c_checkbox >( 0, 0, xors( "through smoke" ), &g_settings.legit.trigger_through_smoke ) );

						triggerbot_form->add_item( std::make_shared< ui::c_checkbox >( 0, 0, xors( "magnet" ), &g_settings.legit.trigger_magnet ) );

						/*auto bt_checkbox = triggerbot_form->add_item( std::make_shared< ui::c_checkbox >( 0, 0, xors( "backtrack" ), &g_settings.legit.trigger_backtrack ) );
						bt_checkbox->set_cond( [ ] { return g_settings.legit.backtracking( ); } );*/
				...
				auto subtab_weapons = std::make_shared< ui::c_tab_sheet >( xors( "weapons" ) ); {
					...
					auto general_form = std::make_shared< ui::c_form >( 0, 0, 215, 0, xors( "general" ), 202 ); {
						general_form->add_item( std::make_shared< ui::c_slider< float > >( 0, 0, 140, 0.f, 40.f, xors( "fov" ), &g_settings.legit.general.m_fov ) );
						general_form->add_item( std::make_shared< ui::c_slider< float > >( 0, 0, 140, 0.f, 100.f, xors( "speed" ), &g_settings.legit.general.m_speed ) );
						general_form->add_item( std::make_shared< ui::c_slider< float > >( 0, 0, 140, 1.f, 2.5f, xors( "speed exponent" ), &g_settings.legit.general.m_exponent ) );
						...
						general_form->add_item( std::make_shared< ui::c_slider< int > >( 0, 0, 140, 0, 100, xors( "triggerbot hitchance" ), &g_settings.legit.general.m_triggerbot_hitchance ) );

						auto hitbox_form = general_form->add_item( std::make_shared< ui::c_form >( 0, 5, 99, 0, xors( "hitbox" ), 0, true ) );
						hitbox_form->add_item( std::make_shared< ui::c_checkbox >( 0, 0, xors( "head" ), &g_settings.legit.general.h_head ) );
						hitbox_form->add_item( std::make_shared< ui::c_checkbox >( 0, 0, xors( "body" ), &g_settings.legit.general.h_body ) );
						hitbox_form->add_item( std::make_shared< ui::c_checkbox >( 0, 0, xors( "arms" ), &g_settings.legit.general.h_arms ) );
						hitbox_form->add_item( std::make_shared< ui::c_checkbox >( 0, 0, xors( "legs" ), &g_settings.legit.general.h_legs ) );
					}

					auto snipers_form = std::make_shared< ui::c_form >( 0, 0, 215, 0, xors( "snipers" ), 202 ); {
						snipers_form->add_item( std::make_shared< ui::c_slider< float > >( 0, 0, 140, 0.f, 40.f, xors( "fov" ), &g_settings.legit.snipers.m_fov ) );
						snipers_form->add_item( std::make_shared< ui::c_slider< float > >( 0, 0, 140, 0.f, 100.f, xors( "speed" ), &g_settings.legit.snipers.m_speed ) );
						snipers_form->add_item( std::make_shared< ui::c_slider< float > >( 0, 0, 140, 1.f, 2.5f, xors( "speed exponent" ), &g_settings.legit.snipers.m_exponent ) );
						...
						snipers_form->add_item( std::make_shared< ui::c_slider< int > >( 0, 0, 140, 0, 100, xors( "triggerbot hitchance" ), &g_settings.legit.snipers.m_triggerbot_hitchance ) );
						//snipers_form->add_item( std::make_shared< ui::c_checkbox >( 0, 0, xors( "awp body aim" ), &g_settings.legit.awp_baim ) );

						auto hitbox_form = snipers_form->add_item( std::make_shared< ui::c_form >( 0, 5, 99, 0, xors( "hitbox" ), 0, true ) );
						hitbox_form->add_item( std::make_shared< ui::c_checkbox >( 0, 0, xors( "head" ), &g_settings.legit.snipers.h_head ) );
						hitbox_form->add_item( std::make_shared< ui::c_checkbox >( 0, 0, xors( "body" ), &g_settings.legit.snipers.h_body ) );
						hitbox_form->add_item( std::make_shared< ui::c_checkbox >( 0, 0, xors( "arms" ), &g_settings.legit.snipers.h_arms ) );
						hitbox_form->add_item( std::make_shared< ui::c_checkbox >( 0, 0, xors( "legs" ), &g_settings.legit.snipers.h_legs ) );
					}

					auto rifles_form = std::make_shared< ui::c_form >( 0, 0, 215, 0, xors( "rifles" ), 202 ); {
						rifles_form->add_item( std::make_shared< ui::c_slider< float > >( 0, 0, 140, 0.f, 40.f, xors( "fov" ), &g_settings.legit.rifles.m_fov ) );
						rifles_form->add_item( std::make_shared< ui::c_slider< float > >( 0, 0, 140, 0.f, 100.f, xors( "speed" ), &g_settings.legit.rifles.m_speed ) );
						rifles_form->add_item( std::make_shared< ui::c_slider< float > >( 0, 0, 140, 1.f, 2.5f, xors( "speed exponent" ), &g_settings.legit.rifles.m_exponent ) );
						...
						rifles_form->add_item( std::make_shared< ui::c_slider< int > >( 0, 0, 140, 0, 100, xors( "triggerbot hitchance" ), &g_settings.legit.rifles.m_triggerbot_hitchance ) );

						auto hitbox_form = rifles_form->add_item( std::make_shared< ui::c_form >( 0, 5, 99, 0, xors( "hitbox" ), 0, true ) );
						hitbox_form->add_item( std::make_shared< ui::c_checkbox >( 0, 0, xors( "head" ), &g_settings.legit.rifles.h_head ) );
						hitbox_form->add_item( std::make_shared< ui::c_checkbox >( 0, 0, xors( "body" ), &g_settings.legit.rifles.h_body ) );
						hitbox_form->add_item( std::make_shared< ui::c_checkbox >( 0, 0, xors( "arms" ), &g_settings.legit.rifles.h_arms ) );
						hitbox_form->add_item( std::make_shared< ui::c_checkbox >( 0, 0, xors( "legs" ), &g_settings.legit.rifles.h_legs ) );
					}

					auto pistols_form = std::make_shared< ui::c_form >( 0, 0, 215, 0, xors( "pistols" ), 202 ); {
						pistols_form->add_item( std::make_shared< ui::c_slider< float > >( 0, 0, 140, 0.f, 40.f, xors( "fov" ), &g_settings.legit.pistols.m_fov ) );
						pistols_form->add_item( std::make_shared< ui::c_slider< float > >( 0, 0, 140, 0.f, 100.f, xors( "speed" ), &g_settings.legit.pistols.m_speed ) );
						pistols_form->add_item( std::make_shared< ui::c_slider< float > >( 0, 0, 140, 1.f, 2.5f, xors( "speed exponent" ), &g_settings.legit.pistols.m_exponent ) );
						...
						pistols_form->add_item( std::make_shared< ui::c_slider< int > >( 0, 0, 140, 0, 100, xors( "triggerbot hitchance" ), &g_settings.legit.pistols.m_triggerbot_hitchance ) );

						auto hitbox_form = pistols_form->add_item( std::make_shared< ui::c_form >( 0, 5, 99, 0, xors( "hitbox" ), 0, true ) );
						hitbox_form->add_item( std::make_shared< ui::c_checkbox >( 0, 0, xors( "head" ), &g_settings.legit.pistols.h_head ) );
						hitbox_form->add_item( std::make_shared< ui::c_checkbox >( 0, 0, xors( "body" ), &g_settings.legit.pistols.h_body ) );
						hitbox_form->add_item( std::make_shared< ui::c_checkbox >( 0, 0, xors( "arms" ), &g_settings.legit.pistols.h_arms ) );
						hitbox_form->add_item( std::make_shared< ui::c_checkbox >( 0, 0, xors( "legs" ), &g_settings.legit.pistols.h_legs ) );
					}
			...
			auto tab_rage = std::make_shared< ui::c_tab_sheet >( xors( "rage" ), &icons::sprite_rage ); {
				...
				auto subtab_aimbot = std::make_shared< ui::c_tab_sheet >( xors( "aimbot" ) ); {
					...
					auto main_form = std::make_shared< ui::c_form >( 0, 0, 215, 215, xors( "main" ), 235 ); {
						...
						main_form->add_item( std::make_shared< ui::c_dropdown< int > >(
							...
							&dropdowns::activation_types_aimbot ) )->add_item(
								std::make_shared< ui::c_key_picker_small >( 195, 0, &g_settings.rage.aimkey, xors( "rage_activation_type" ) ) )->set_cond(
					...
					auto accuracy_form = std::make_shared< ui::c_form >( 0, 0, 215, 157, xors( "accuracy" ), 157 ); {
						...
						//accuracy_form->add_item( std::make_shared< ui::c_checkbox >( 0, 0, xors( "resolve moving (wip)" ), &g_settings.rage.dbg_moving_resolver )
						//)->set_cond( [ ]( ) { return g_settings.rage.resolver; } );
						...
						visualize_checkbox->add_item( std::make_shared< ui::c_color_picker >( 175, 2, 16, &g_settings.rage.bt_col ) );
				...
				auto subtab_antiaim = std::make_shared< ui::c_tab_sheet >( xors( "antiaim" ) ); {
					...
					auto yaw_form = std::make_shared< ui::c_form >( 0, 0, 215, 190, xors( "yaw" ), 190 ); {
						...
						auto desync = yaw_form->add_item( std::make_shared< ui::c_dropdown< > >( 0, 0, 140, xors( "fake yaw" ), &g_settings.rage.fake_yaw, &dropdowns::antiaim_fake ) );
						desync->add_item( std::make_shared< ui::c_color_picker >( 175, 2, 16, &g_settings.visuals.desync_clr ) )->set_cond( [ ]( ) { return g_settings.rage.fake_yaw; } );
					}
					...
					auto lby_form = std::make_shared< ui::c_form >( 0, 0, 215, 47, xors( "other" ), 47 ); {
						lby_form->add_item( std::make_shared< ui::c_checkbox >( 0, 0, xors( "slowwalk" ), &g_settings.rage.fakewalk ) )->add_item(
							std::make_shared< ui::c_key_picker_small >( 195, 0, &g_settings.rage.fakewalk_key, xors( "fake_walk_key" ) )
						);

						lby_form->add_item( std::make_shared< ui::c_slider< int > >( 0, 0, 140, 0, 33, &g_settings.rage.fakewalk_ticks ) );
					}

					auto fakelag_form = std::make_shared< ui::c_form >( 0, 0, 215, 224, xors( "fakelag" ), 224 ); {
			...
			auto tab_visuals = std::make_shared< ui::c_tab_sheet >( xors( "visuals" ), &icons::sprite_visuals ); {
				...
				auto subtab_players = std::make_shared< ui::c_tab_sheet >( xors( "players" ) ); {
					...
					auto main_form = std::make_shared< ui::c_form >( 0, 0, 215, 0, xors( "main" ) ); {
						main_form->add_item( std::make_shared< ui::c_dropdown< > >( 0, 0, 120, xors( "activation type" ), &g_settings.visuals.activation_type, &dropdowns::activation_type_visuals ) )->add_item(
							std::make_shared< ui::c_key_picker_small >( 195, 0, &g_settings.visuals.key, xors( "legit_activation_type" ) ) )->set_cond( [ ]( ) { return g_settings.visuals.activation_type > 1; } );
						main_form->add_item( std::make_shared< ui::c_checkbox >( 0, 0, xors( "friendlies" ), &g_settings.visuals.friendlies ) );
					}

					auto player_form = std::make_shared< ui::c_form >( 0, 0, 215, 0, xors( "players" ), 305 ); {
						...
						glow_checkbox->add_item( std::make_shared< ui::c_color_picker >( 160, 2, 16, &g_settings.visuals.glow_enemy ) );
						glow_checkbox->add_item( std::make_shared< ui::c_color_picker >( 180, -11, 16, &g_settings.visuals.glow_friendly ) )->set_cond(
						...
						skeleton_checkbox->add_item( std::make_shared< ui::c_color_picker >( 160, 2, 16, &g_settings.visuals.skeleton_enemy ) );
						skeleton_checkbox->add_item( std::make_shared< ui::c_color_picker >( 180, -11, 16, &g_settings.visuals.skeleton_friendly ) )->set_cond(
					...
					auto hud_form = std::make_shared< ui::c_form >( 0, 0, 215, 0, xors( "hud" ) ); {
						auto out_of_pov = hud_form->add_item( std::make_shared< ui::c_checkbox >( 0, 0, xors( "out of pov" ), &g_settings.visuals.out_of_pov ) );
						out_of_pov->add_item( std::make_shared< ui::c_color_picker >( 160, 2, 16, &g_settings.visuals.box_enemy ) );
						out_of_pov->add_item( std::make_shared< ui::c_color_picker >( 180, -11, 16, &g_settings.visuals.box_friendly ) )->set_cond(
							[ ]( ) { return g_settings.visuals.friendlies; } );
				...
				auto subtab_other = std::make_shared< ui::c_tab_sheet >( xors( "other" ) ); {
					...
					auto world_form = std::make_shared< ui::c_form >( 0, 0, 215, 0, xors( "world" ), 235 ); {
						...
						)->add_item( std::make_shared< ui::c_color_picker >( 180, 4, 16, &g_settings.visuals.weapon_esp_clr( ) ) );
						...
						)->add_item( std::make_shared< ui::c_color_picker >( 180, 4, 16, &g_settings.visuals.grenade_esp_clr( ) ) );
					...
					auto local_form = std::make_shared< ui::c_form >( 0, 0, 215, 0, xors( "local player" ), 215 ); {
						local_form->add_item( std::make_shared< ui::c_checkbox >( 0, 0, xors( "recoil crosshair" ), &g_settings.visuals.recoil_crosshair( ) ) );
						local_form->add_item( std::make_shared< ui::c_checkbox >( 0, 0, xors( "draw spread" ), &g_settings.visuals.draw_spread( ) ) )->add_item( 
							std::make_shared< ui::c_color_picker >( 180, 4, 16, &g_settings.visuals.draw_spread_clr )
						);
						...
						local_form->add_item( std::make_shared< ui::c_checkbox >( 0, 0, xors( "grenade prediction" ), &g_settings.visuals.grenade_prediction( ) ) )->add_item( 
							std::make_shared< ui::c_color_picker >( 180, 4, 16, &g_settings.visuals.grenade_pred_clr )
						);

						local_form->add_item( std::make_shared< ui::c_checkbox >( 0, 0, xors( "snipers crosshair" ), &g_settings.visuals.snipers_crosshair( ) ) );
						local_form->add_item( std::make_shared< ui::c_checkbox >( 0, 0, xors( "kill effect" ),  &g_settings.visuals.kill_effect( ) ) );
					}
					...
					auto view_form = std::make_shared< ui::c_form >( 0, 0, 215, 0, xors( "view" ) ); {
						...
						view_form->add_item( std::make_shared< ui::c_checkbox >( 0, 0, xors( "thirdperson" ), &g_settings.misc.thirdperson( ) ) )->add_item(
							std::make_shared< ui::c_key_picker_small >( 195, 0, &g_settings.misc.thirdperson_key, xors( "thirdperson_key" ) )
						);

						view_form->add_item( std::make_shared< ui::c_slider< float > >( 0, 0, 120, 50.f, 200.f, xors( "distance" ), &g_settings.misc.thirdperson_dist( ) )
						)->set_cond( [ ]( ) { return g_settings.misc.thirdperson; } );
					...
					auto removals_form = std::make_shared< ui::c_form >( 0, 0, 215, 0, xors( "removals" ), 235 ); {
						...
						removals_form->add_item( std::make_shared< ui::c_checkbox >( 0, 0, xors( "zoom on double scope" ), &g_settings.misc.zoom_on_double_scope ) 
						)->set_cond( [ ]( ) { return g_settings.misc.no_zoom; } );
            ...
            movement_form->add_item( std::make_shared< ui::c_dropdown< > >( 0, 0, 120, xors( "jump bug" ), &g_settings.misc.jump_bug_type, &dropdowns::jump_bug_types ) )->add_item(
              std::make_shared< ui::c_key_picker_small >( 195, 1, &g_settings.misc.jump_bug_key( ), xors( "jump_bug_key" ) )
						...
						movement_form->add_item( std::make_shared< ui::c_checkbox >( 0, 0, xors( "fast walk" ), &g_settings.misc.fastwalk( ) ) )->add_item(
							std::make_shared< ui::c_key_picker_small >( 195, 1, &g_settings.misc.fastwalk_key( ), xors( "fast_walk_key" ) )
						);
					}
					...
					auto fake_ping = std::make_shared< ui::c_form >( 0, 0, 215, 0, xors( "fake latency" ), 215 ); {
					...
					auto helpers_form = std::make_shared< ui::c_form >( 0, 0, 215, 0, xors( "helpers" ), 235 ); {
						...
						helpers_form->add_item( std::make_shared< ui::c_checkbox >( 0, 0, xors( "log purchases" ), &g_settings.misc.log_purchases ) );
					...
					auto other_form = std::make_shared< ui::c_form >( 0, 0, 215, 0, xors( "other" ), 110 ); {
						other_form->add_item( std::make_shared< ui::c_checkbox >( 0, 0, xors( "adjust sounds" ), &g_settings.misc.no_sound ) );

						other_form->add_item( std::make_shared< ui::c_slider< float > >( 0, 0, 120, 0.f, 1.f, xors( "weapon volume" ), &g_settings.misc.weapon_volume ) 
						)->set_cond( [ ]( ) { return g_settings.misc.no_sound( ); } );
				...
				auto subtab_skins = std::make_shared< ui::c_tab_sheet >( xors( "money compensator" ) ); {
					...
					auto skin_form = left_column->add_item( std::make_shared< ui::c_form >( 0, 0, 215, 0, xors( "skin" ), 325 ) ); {
						skin_form->add_item( std::make_shared< ui::c_checkbox >( 0, 0, xors( "stattrak" ), &g_settings.misc.skins.current_stattrak ) );
						skin_form->add_item( std::make_shared< ui::c_slider< int > >( 0, 0, 120, 0, 1000, xors( "seed" ), &g_settings.misc.skins.current_seed ) );
				...
				auto subtab_movement_recorder = std::make_shared< ui::c_tab_sheet >( xors( "movement recorder" ) ); {
					auto main_form = std::make_shared< ui::c_form >( 0, 0, 215, 0, xors( "main" ) ); {
						...
						main_form->add_item( std::make_shared< ui::c_label >( 0, 0, xors( "recording start key" ) ) )->add_item(
							std::make_shared< ui::c_key_picker_small >( 195, 0, &g_settings.misc.recording_start_key, xors( "start_recording_key" ) )
						);
						main_form->add_item( std::make_shared< ui::c_label >( 0, 0, xors( "recording stop key" ) ) )->add_item(
							std::make_shared< ui::c_key_picker_small >( 195, 0, &g_settings.misc.recording_stop_key, xors( "recording_stop_key" ) )
						);
			...
			auto tab_config = std::make_shared< ui::c_tab_sheet >( xors( "config" ), &icons::sprite_config ); {
				auto cfg_form = std::make_shared< ui::c_form >( 0, 10, 200, 180, xors( "config" ) );
				...
				label->add_item( std::make_shared< ui::c_color_picker >( 165, 4, 16, &g_settings.menu.menu_color ) );

				cfg_form->add_item( std::make_shared< ui::c_dropdown< > >( 0, -50, 120, xors( "menu theme" ), &g_settings.menu.theme, &dropdowns::menu_themes ) );
				...
				auto js_form = tab_config->add_item( std::make_shared< ui::c_form >( 0, 15, 200, 0, xors( "scripts" ), 275 ) ); {
					static int dummy = 0;
					js_form->add_item( std::make_shared< ui::c_button >( 0, 0, 85, 20, xors( "reload scripts" ), [ ]( ) { was_setup = false; render( ); g_js->parse_files( ); } ) );
					js_form->add_item( std::make_shared< ui::c_itemlist< int, 10 > >( 0, 0, 160, xors( "loaded scripts" ), g_js->get_parsed( ), &dummy ) );
				}
			}
